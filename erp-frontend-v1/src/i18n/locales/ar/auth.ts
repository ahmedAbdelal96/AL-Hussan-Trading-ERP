...
export const auth = {
  login: {
    ...
    brandTitle: "شركة الحصان للمقاولات",
    brandSubtitle: "نظام داخلي لتنظيم أعمال الشركة ومتابعة العمليات التشغيلية.",
    badge: "دخول النظام الداخلي",
    secureAccess: "دخول آمن",
    organizedFollowUp: "متابعة منظمة",
    roleAccess: "صلاحيات حسب الدور",
    help: "تحتاج مساعدة في تسجيل الدخول؟",
    ...
    enterprise: {
      badge: "دخول النظام الداخلي",
      tagSecure: "دخول آمن",
      tagAudited: "صلاحيات حسب الدور",
      sideTitle: "شركة الحصان للمقاولات",
      sideDescription: "نظام داخلي لتنظيم أعمال الشركة ومتابعة العمليات التشغيلية.",
      featureSecurityTitle: "دخول آمن",
      featureSecurityDesc: "صلاحيات مشفرة للموظفين المصرح لهم.",
      featureLiveDataTitle: "متابعة منظمة",
      featureLiveDataDesc: "متابعة مستمرة لعمليات التنفيذ والمواقع.",
      featureEnterpriseTitle: "صلاحيات حسب الدور",
      featureEnterpriseDesc: "صلاحيات واضحة ومحددة لكل دور وظيفي.",
    },
  },
